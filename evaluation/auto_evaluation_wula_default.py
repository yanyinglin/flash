...
# evaluation_record = pd.read_csv("metrics/evaluation_record_wrk.csv", names=columns)
# function_model_size = pd.read_csv("../benchmark/function_model_size.csv", header=0)

flashes=["shufflenet-fwm","vggnet-11-fwm","bert-fwm","bert-qa-fwm","labse-fwm","resnet-50-fwm","resnet-101-fwm","resnet-152-fwm"]
